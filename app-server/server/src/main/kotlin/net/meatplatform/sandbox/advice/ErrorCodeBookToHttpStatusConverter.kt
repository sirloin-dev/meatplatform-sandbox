...
fun ErrorCodeBook.toHttpStatus(): HttpStatus = when(this) {
    ...
    ErrorCodeBook.UNAUTHENTICATED -> HttpStatus.UNAUTHORIZED
    ErrorCodeBook.UNAUTHORIZED -> HttpStatus.FORBIDDEN
    ErrorCodeBook.AUTHENTICATION_EXPIRED -> HttpStatus.UNAUTHORIZED
